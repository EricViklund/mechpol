...
\logoleft{\parbox{0.05\textwidth}{\includegraphics[width=7cm]{logos/FNAL-Logo-White.png} \newline \vspace{1cm} \includegraphics[width=7cm]{logos/Northwestern-Logo-White.png} \newline \vspace{1cm} \includegraphics[width=7cm]{logos/DOE_SC_Logo_White.png}}}
